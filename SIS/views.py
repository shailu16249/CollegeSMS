...
from .forms import StudentForm,FacultyForm,UserForm,LeaveRequestForm,SubjectForm

class dates(forms.Form):
        date = DateField(widget=
        SelectDateWidget(empty_label=("Choose Year", "Choose Month", "Choose Day")), initial=datetime.date.today)
